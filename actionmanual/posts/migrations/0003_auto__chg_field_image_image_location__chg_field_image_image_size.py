...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Image.image_location'
        db.alter_column('posts_image', 'image_location', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Image.image_size'
        db.alter_column('posts_image', 'image_size', self.gf('django.db.models.fields.IntegerField')())


    def backwards(self, orm):
        
        # Changing field 'Image.image_location'
        db.alter_column('posts_image', 'image_location', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'Image.image_size'
        db.alter_column('posts_image', 'image_size', self.gf('django.db.models.fields.CharField')(max_length=50))
