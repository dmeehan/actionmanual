...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('contacts_people', 'tags', self.gf('tagging.fields.TagField')(default=' '), keep_default=False)

        # Adding field 'Organization.tags'
        db.add_column('contacts_organization', 'tags', self.gf('tagging.fields.TagField')(default=' '), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Person.tags'
        db.delete_column('contacts_people', 'tags')

        # Deleting field 'Organization.tags'
        db.delete_column('contacts_organization', 'tags')
