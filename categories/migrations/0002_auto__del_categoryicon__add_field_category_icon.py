...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('categories_category', 'icon', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('categories_category', 'icon')
