...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'FeaturedCategoryIdea'
        db.create_table('portfolio_featuredcategoryidea', (
        ...
        db.send_create_signal('portfolio', ['FeaturedCategoryIdea'])


    def backwards(self, orm):
        
        # Deleting model 'FeaturedCategoryIdea'
        db.delete_table('portfolio_featuredcategoryidea')
    ...
    models = {
        ...
        'categories.category': {
            'Meta': {'ordering': "['-group', 'order']", 'object_name': 'Category'},
        ...
        'portfolio.featuredcategoryidea': {
            'Meta': {'object_name': 'FeaturedCategoryIdea'},
